      ...
      <div className='container'>
        <div className='flex justify-end'>
          ...
          {isAuthenticated && (
            <Popover
              ...
              renderPopover={
                <div>
                  <Link to={path.profile} className='block py-2 px-3 hover:bg-slate-100 bg-white hover:text-cyan-600'>
                    Tài khoản của tôi
                  </Link>
                  <Link to={'/'} className='block py-2 px-3 hover:bg-slate-100 bg-white hover:text-cyan-600'>
                    Đơn mua
                  </Link>
                  <button
                    className='block w-full text-left py-2 px-3 hover:bg-slate-100 bg-white hover:text-cyan-600'
        ...
        <div className='grid grid-cols-12 gap-2 mt-4 items-end'>
          <Link to={'/'} className='col-span-2'>
            <svg viewBox='0 0 192 65' className='w-full h-12 fill-white'>
              <g>
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://down-vn.img.susercontent.com/file/cn-11134207-7r98o-lnth3m5ir72g42_tn'
                            alt='ảnh'
                        ...
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='truncate'>
                            Điện Thoại Ốp Lưng Hình Rồng Cho samsung galaxy a72 a52 a52s a42 a32 4g 5g
                          </div>
                        </div>
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>₫59.409</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
